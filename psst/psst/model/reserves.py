...
def initialize_global_reserves(model, DownReservePercent=None, UpReservePercent=None,
    ...
    model.ReserveUpRequirement = Param(model.TimePeriods, initialize=reserve_up_requirement, within=NonNegativeReals,
...
def initialize_zonal_reserves(model, PriceSenLoadFlag=False, zone_names=None, buses_at_each_zone=None,
                              ZonalDownReservePercent=None, ZonalUpReservePercent=None,
    ...
    model.ZonalDownReservePercent = Param(model.ReserveZones, initialize=ZonalDownReservePercent,
                                          within=NonNegativeReals, default=0.0, mutable=True)
    model.ZonalUpReservePercent = Param(model.ReserveZones, initialize=ZonalUpReservePercent, within=NonNegativeReals,
                                        default=0.0, mutable=True)
