...
# has been modified by Swathi Battula to make the code
...
def maximum_minimum_storage_power_output(model,
    ...
    # \overbar{x}_s(0)
    model.StoragePowerOutputOnT0 = Param(model.Storage, within=NonNegativeIntegers,
                                         validate=t0_storage_power_output_validator, default=0)
    # \underbar{x}_s(0)
    model.StoragePowerInputOnT0 = Param(model.Storage, within=NonNegativeIntegers,
                                        validate=t0_storage_power_input_validator, default=0)
    # SOC_S(0)
