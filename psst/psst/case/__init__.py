...
class PSSTCase(object):
    ...
    def _read_matpower(cls, mpc, auto_assign_names=True, fill_loads=True, remove_empty=True, reset_generator_status=True):
        ...
        mpc.gen['SCALED_STARTUP_RAMP'] = mpc.gen['PMAX']
        mpc.gen['SCALED_SHUTDOWN_RAMP'] = mpc.gen['PMAX']
        mpc.gen['SCALED_MINIMUM_UP_TIME'] = 0
        mpc.gen['SCALED_MINIMUM_DOWN_TIME'] = 0
        mpc.gen['InitialTimeON'] = 0
